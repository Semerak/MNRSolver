...
namespace WindowsFormsApp3
{
    class ThrowExceptionErrorListener : BaseErrorListener, IAntlrErrorListener<int>
    {
        ...
        public override void SyntaxError(IRecognizer recognizer, IToken offendingSymbol, int line, int
        ...
        public void SyntaxError(IRecognizer recognizer, int offendingSymbol, int line, int charPositionInLine, string
